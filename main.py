...
class ZK9500:
    ...
    def ReciveImage(self):
        ...
        # -----------------------------------------------------
        # 🚀 [เพิ่มโค้ดตรงนี้] ส่งคำสั่งเปิดไฟ LED และ Sensor กระแทกเข้าไปก่อนดูด!
        print("   -> 💡 สั่งเปิดไฟสแกน (LED ON)!")
        self.send_cmd(0x40, 225, 0x0001, 83)
        self.send_cmd(0x40, 225, 0x0001, 49) # ใส่ 1 เพื่อเปิด Reg 49
        self.send_cmd(0x40, 225, 0x0003, 48) # ใส่ 3 เพื่อเปิด Reg 48
        time.sleep(0.2) # รอให้ไฟสว่างเต็มที่สัก 200ms
        # -----------------------------------------------------
